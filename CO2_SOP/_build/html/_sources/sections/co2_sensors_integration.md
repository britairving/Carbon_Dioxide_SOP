...
:::{figure-md} hydroc
<img src="/docs/sensor_integration.png"  alt="hydroc" class="bg-primary mb-1" width="500px">>
...
<img src="/docs/table_integration.png" alt="spec" class="bg-primary mb-1" width="500px">
...
:::{figure-md} seaglider
<img src="/docs/CO2Seaglider.png" alt="Seaglider" class="bg-primary mb-1" width="600px">
...
<img src="/docs/mounting.png" alt="mount" class="bg-primary mb-1" width="600px">
